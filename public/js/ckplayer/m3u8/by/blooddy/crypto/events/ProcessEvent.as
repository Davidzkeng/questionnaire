...
package by.blooddy.crypto.events {
	...
	public class ProcessEvent extends Event {
		 ...
		 * 						this newscategory through the inherited type property.
		 * @param	bubbles		Determines whether the Event object bubbles. Event
		 * 						listeners can access this newscategory through the
		 * 						inherited bubbles property.
		 * @param	cancelable	Determines whether the Event object can be canceled.
		 * 						Event listeners can access this newscategory through
